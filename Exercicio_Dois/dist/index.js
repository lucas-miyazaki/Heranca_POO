...
console.clear();
const bNm1 = new BebeNatimorto_1.BebeNatimorto(`Jubilinho`, 2.5, 25, `falta de oxigenação`);
...
console.log(`Altura: `, bNm1.getAltura() + "cm");
console.log("Causa da morte: " + bNm1.getCausa());
const bN1 = new BebeNormal_1.BebeNormal(`Jubilinho Jr`, 4, 38, false);
...
console.log(`Altura: `, bN1.getAltura() + "cm");
console.log("Vacinado: " + bN1.getVacinado());
const bP1 = new BebePrematuro_1.BebePrematuro(`Jubileu Jr`, 2.5, 17, 30);

...
console.clear();
const bNm1 = new BebeNatimorto(`354235235`, `Jubilinho`, 2.5, 25, `falta de oxigenação`);

console.log(`Id: `, bNm1.getId())
...
const bN1 = new BebeNormal(`9879876424`, `Jubilinho Jr`, 4, 38, false);

console.log(`Id: `, bN1.getId())
...
const bP1 = new BebePrematuro(`634242353463`, `Jubileu Jr`, 2.5, 17, 30);

console.log(`Id: `, bP1.getId())
